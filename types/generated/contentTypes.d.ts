...
export interface ApiCategoryCategory extends Schema.CollectionType {
  ...
  attributes: {
    ...
    imageDesktop: Attribute.Media<'images' | 'files' | 'videos' | 'audios'>;
    imageTablet: Attribute.Media<'images' | 'files' | 'videos' | 'audios'>;
...
export interface ApiHomePageHomePage extends Schema.CollectionType {
  ...
  attributes: {
    ...
    ProductLg: Attribute.Component<'blocks.product-lg'>;
    ProductGrid: Attribute.Component<'blocks.product-grid'>;
    ProductBig: Attribute.Component<'blocks.product-big'>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiProductProduct extends Schema.CollectionType {
  ...
  attributes: {
    ...
    product: Attribute.Relation<
      ...
      'api::product.product'
    >;
    gallery: Attribute.Media<'images' | 'videos' | 'audios', true>;
